...
const Ripple = () => {
  ...
  const triggerRipple = (e: React.MouseEvent<HTMLDivElement> | React.TouchEvent<HTMLDivElement>) => {
    const clientX = (("clientX" in e) ? e.clientX : e.targetTouches?.[0]?.clientX) || 0;
    const clientY = (("clientY" in e) ? e.clientY : e.targetTouches?.[0]?.clientY) || 0;
