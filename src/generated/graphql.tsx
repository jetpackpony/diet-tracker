...
export type SearchFoodItemsQuery = { __typename?: 'Query', filterFoodItems: Array<{ __typename?: 'FoodItem', id: string, title: string, calories: number, protein: number, fat: number, carbs: number }> };
